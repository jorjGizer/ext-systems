...
public class Server {
    ...
    public static Map<String, Greetable> loadHandlers() {
        Map<String, Greetable> result = new HashMap<>();
            try (BufferedInputStream is = new BufferedInputStream(Files.newInputStream(Paths.get("src/main/resources/server.properties")))) {
